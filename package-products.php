...
require 'engine/get-dollar.php';
    ...
    $products_category = mysqli_query($conn,"select * from item_detail where product_category = '$page' and used = 0 and sold = 0");

    if ($products_category->num_rows > 0) {
...
require 'engine/configure.php';
$condition = "SELECT * from item_detail where sold = 0 and product_category='$page'  and used = 0 order by id desc";
...
$condition = "SELECT * from item_detail where sold = 0 and product_category='$page' and discount>0 and used = 0 order by id desc";
$data = mysqli_query($conn,$condition);
$datafound = $data->num_rows;
echo "<table><tbody id='mytable' class=''>";
...
$condition = "SELECT * from item_detail where sold = 0 and product_category='$page' and product_price<10000 and used = 0 order by id desc";
$data = mysqli_query($conn,$condition);
$datafound = $data->num_rows;
echo "<table><tbody id='mytable' class=''>";
