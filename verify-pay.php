...
if($status =='success'){
$update = mysqli_query($conn,"update vendor_profile set status = 1 where id = '".htmlspecialchars($_SESSION['business_id'])."'"); 
if($update){echo"<h6 style='color:green;'><b>Payment was successful</b></h6><br>";
    echo"<p>Kindly proceed to <a href='postadvert.php'>Upload</a> page to continue</p>";
}
}
