...
$pricing = $_SESSION['price'];
if(isset($_GET['reference'])){
$reference = $_GET['reference'];
require 'engine/configure.php';
$getprovider = mysqli_query($conn,"select * from service_providers where sp_id ='".$provider_id."'");
if ($getprovider) {
while ($row = mysqli_fetch_array($getprovider)) {
$sp_name = $row['sp_name'];
$sp_speciality= $row['sp_speciality'];

echo"<h6><b>".$reference."</b></h6><br><br>";
echo"<strong style='opacity:0.7'>Payment to ".$sp_name." was successful.</strong><br>";
echo"Specialization: ".$sp_speciality;
