...
$insertQuery="INSERT INTO service_providers(sp_name,sp_category,sp_speciality,sp_location,sp_email,sp_password,sp_phonenumber1,sp_phonenumber2,sp_experience,sp_bio,ratings,sp_verified,e_verify,vkey,date) VALUES ('".htmlspecialchars($sp_name)."','".htmlspecialchars($sp_category)."','".htmlspecialchars($sp_speciality)."','".htmlspecialchars($sp_location)."','".htmlspecialchars($sp_email)." ','".htmlspecialchars($secret_password)."','".htmlspecialchars($sp_phonenumber)."','".htmlspecialchars($sp_phonenumber2)."','0','".htmlspecialchars($sp_experience)."','".htmlspecialchars($sp_bio)."','".htmlspecialchars($sp_ratings)."','".htmlspecialchars($verified)."','".htmlspecialchars($e_verify)."','".htmlspecialchars($vkey)."','".$date."')";
