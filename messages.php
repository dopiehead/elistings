...
echo"<script>location.href='messages-sp.php'</script>";
...
<a id="active"><i class="fa fa-envelope"></i> Messages(<?php echo $inbox  ?>)
...
$getnotification = mysqli_query($conn,"select * from vendor_notifications where pending = 0 and recipient_id ='".htmlspecialchars($you_id)."'");
...
$getnotification = mysqli_query($conn,"select * from sp_notifications where pending = 0 and recipient_id ='".htmlspecialchars($you_id)."'");
...
if (isset($_SESSION['id'])) {
$you_id = $_SESSION['id'];
$getnotification = mysqli_query($conn,"select * from buyer_notifications where pending = 0 and recipient_id ='".htmlspecialchars($you_id)."'");
