...
<?php if (!empty($_SESSION['name'])) {
	   ...
	   echo '<input type="hidden" name="name" id="name" class="form-control" style="font-family: arial,Fontawesome" placeholder="&#xF007; Name" value="'.$name.'">';
      echo'<br>';	
     echo'<input type="hidden" name="email" id="email" class="form-control" style="font-family: arial,Fontawesome" placeholder="&#xF1fa; Email" value="'.$email.'">';

      echo'<input type="hidden" name="user_type" id="user_type" class="form-control" style="font-family: arial,Fontawesome" placeholder="&#xF1fa; Email" value="buyer">';
} 


elseif (!empty($_SESSION['business_name'])) {
	
	   echo '<input type="hidden" name="name" id="name" class="form-control" style="font-family: arial,Fontawesome" placeholder="&#xF007; Name" value="'.$business_name.'">';
      echo'<br>';	
     echo'<input type="hidden" name="email" id="email" class="form-control" style="font-family: arial,Fontawesome" placeholder="&#xF1fa; Email" value="'.$business_email.'">';

      echo'<input type="hidden" name="user_type" id="user_type" class="form-control" style="font-family: arial,Fontawesome" placeholder="&#xF1fa; Email" value="vendor">';
} 


elseif (!empty($_SESSION['sp_name'])) {
	
	   echo '<input type="hidden" name="name" id="name" class="form-control" style="font-family: arial,Fontawesome" placeholder="&#xF007; Name" value="'.$sp_name.'">';
      echo'<br>';	
     echo'<input type="hidden" name="email" id="email" class="form-control" style="font-family: arial,Fontawesome" placeholder="&#xF1fa; Email" value="'.$sp_email.'">';

         echo'<input type="hidden" name="user_type" id="user_type" class="form-control" style="font-family: arial,Fontawesome" placeholder="&#xF1fa; Email" value="service provider">';
} 
...
echo '<input type="text" name="name" id="name" class="form-control" style="font-family: arial,Fontawesome;font-size:13px;" placeholder="&#xF007; Name"';echo'<br><br>';
...
<br>
<textarea name="message" style="font-size:13px;" id="message" class="form-control" wrap="physical" placeholder="...Write a message" rows="3" ></textarea> 

<br>

<input type="hidden" name="user_type" id="user_type"  value="non-member" >

<div align="center" style="display: none;" id="loading-image"><img id="loader" height="50" width="80" src="loading-image.GIF"></div>
 <div style=""><button type="button" id="submit2" class="btn  btn-primary form-control" style="color: white;" name=""> Send </button><br><br>
