<?php session_start();
 ...
 if (!isset($_SESSION["id"]) && !isset($_SESSION["business_id"]) && !isset($_SESSION["sp_id"] )) { 
  ...
  if(!isset($_SESSION["sp_id"])){ echo"<script>location.href='dashboard.php'</script>";}
...
<html>
<head>
  <title>E-stores | Work experience</title>
...
<a href="messages-sp.php"><i class="fa fa-envelope"></i> 
Messages(<?php echo $inbox  ?>)
</a><br>
...
<a id="active" href="work-experience.php"><i class='fa fa-history'></i> Work Experience</a><br>
...
<br>
  <h6 style="text-transform:capitalize;">Add work Experience</h6>
...
<p><span><b>Note:</b></span> Not more than 3 images (Max 5MB)</p>
...
<select name="currency"><option value="$">$</option><option value=" &#9839;"> &#9839;</option></select><br><br>

<input type="number" min="1" minlength="4" name="charge" class="form-control" placeholder="charge in NRN">



<br><br>

<button type="submit" name="submit" id="submit" class="btn btn-success" style="float:left;font-size: 13px;">Save  &#10095;</button>
